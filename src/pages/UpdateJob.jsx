...
const UpdateJob = () => {
  ...
  const handleUpdateJob = (e) => {
    ...
    axios
      .put(`https://dot-job-server.vercel.app/myjob/${_id}`, newJob)
      .then((response) => {
  ...
  return (
    <>
      <div className="w-full mx-auto lg:w-[500px] drop-shadow-lg bg-white my-8 md:my-10">
        <form onSubmit={handleUpdateJob} className="p-12">
          <h1 className="backdrop-blur-sm text-4xl pb-8">Update Job</h1>
          <div className="space-y-5">
            ...
            <div className="flex gap-6">
              ...
              <select name="job_catagory" defaultValue={catagory}>
